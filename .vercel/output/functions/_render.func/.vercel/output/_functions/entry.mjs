...
import { l as levels, g as getEventPrefix, L as Logger, A as AstroIntegrationLogger, m as manifest } from './chunks/_@astrojs-manifest_C8PVCCB5.mjs';
import { A as AstroError, i as i18nNoLocaleFoundInPath, f as appendForwardSlash, j as joinPaths, g as MiddlewareNoDataOrNextCalled, h as MiddlewareNotAResponse, G as GetStaticPathsRequired, k as InvalidGetStaticPathsReturn, l as InvalidGetStaticPathsEntry, m as GetStaticPathsExpectedParams, n as GetStaticPathsInvalidRouteParam, t as trimSlashes, P as PageNumberParamNotFound, o as NoMatchingStaticPathFound, p as PrerenderDynamicEndpointPathCollide, q as ReservedSlotName, L as LocalsNotAnObject, r as PrerenderClientAddressNotAvailable, C as ClientAddressNotAvailable, S as StaticClientAddressNotAvailable, s as RewriteWithBodyUsed, u as AstroResponseHeadersReassigned, R as ResponseSentError, v as fileExtension, w as slash, x as prependForwardSlash, y as removeTrailingForwardSlash } from './chunks/astro/assets-service_DPS6fqyt.mjs';
import { R as ROUTE_TYPE_HEADER, a as REROUTE_DIRECTIVE_HEADER, D as DEFAULT_404_COMPONENT, r as renderSlotToString, b as renderJSX, c as chunkToString, i as isRenderInstruction, d as clientLocalsSymbol, e as clientAddressSymbol$1, f as renderPage, g as renderEndpoint, A as ASTRO_VERSION, h as responseSentSymbol, j as REROUTABLE_STATUS_CODES } from './chunks/astro/server_CyOu4KzJ.mjs';
import 'cookie';
import { A as AstroCookies, s as sequence, d as defineMiddleware, o as onRequest } from './chunks/_astro-internal_middleware_C7G9PJRp.mjs';
import 'html-escaper';
import 'clsx';
import 'kleur/colors';
import 'fast-glob';
...
const _page2 = () => import('./pages/api/collect/_id_.astro.mjs');
const _page3 = () => import('./pages/api/collections.astro.mjs');
const _page4 = () => import('./pages/api/comments.astro.mjs');
const _page5 = () => import('./pages/api/likes/comments/_id_.astro.mjs');
const _page6 = () => import('./pages/api/likes/reply/_id_.astro.mjs');
const _page7 = () => import('./pages/api/login.astro.mjs');
const _page8 = () => import('./pages/api/logout.astro.mjs');
const _page9 = () => import('./pages/api/post.astro.mjs');
const _page10 = () => import('./pages/api/profile.astro.mjs');
const _page11 = () => import('./pages/api/protected.astro.mjs');
const _page12 = () => import('./pages/api/register.astro.mjs');
const _page13 = () => import('./pages/api/reply.astro.mjs');
const _page14 = () => import('./pages/blog.astro.mjs');
const _page15 = () => import('./pages/blog/_---slug_.astro.mjs');
const _page16 = () => import('./pages/category.astro.mjs');
const _page17 = () => import('./pages/formblog/edit/_id_.astro.mjs');
const _page18 = () => import('./pages/formblog.astro.mjs');
const _page19 = () => import('./pages/popular.astro.mjs');
const _page20 = () => import('./pages/profile.astro.mjs');
const _page21 = () => import('./pages/redirected.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/api/collect/[Id].ts", _page2],
    ["src/pages/api/collections.ts", _page3],
    ["src/pages/api/comments.ts", _page4],
    ["src/pages/api/likes/comments/[Id].ts", _page5],
    ["src/pages/api/likes/reply/[Id].ts", _page6],
    ["src/pages/api/login.ts", _page7],
    ["src/pages/api/logout.ts", _page8],
    ["src/pages/api/post.ts", _page9],
    ["src/pages/api/profile.ts", _page10],
    ["src/pages/api/protected.ts", _page11],
    ["src/pages/api/register.ts", _page12],
    ["src/pages/api/reply.ts", _page13],
    ["src/pages/blog/index.astro", _page14],
    ["src/pages/blog/[...slug].astro", _page15],
    ["src/pages/category.astro", _page16],
    ["src/pages/formblog/edit/[id]/index.astro", _page17],
    ["src/pages/formblog/index.astro", _page18],
    ["src/pages/popular.astro", _page19],
    ["src/pages/profile.astro", _page20],
    ["src/pages/redirected.astro", _page21],
...
const _args = {
    "middlewareSecret": "e50ac363-32fc-4aed-9136-ccceaa99c1e3",
